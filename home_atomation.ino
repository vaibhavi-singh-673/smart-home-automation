...
const char* ssid     = "realme 9 Pro+";  //WIFI Name
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("<style>html { font-family: Playfair Display Black; display: inline-block; margin: 0px auto; text-align: center;}");
            ...
            // Web Page Heading
            client.println("<body><h1>Smart Home Automation Webserver WOC</h1>");
